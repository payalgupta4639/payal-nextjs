    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">   
        <p>
          ...
          <br/><br/>
          1. <strong>Create video tutorials to help teach users a specific feature or use case:</strong> Creating video tutorials with clear visual instructions can help enhance user experience and reduce the number of support tickets. I like creating content such as writing technical documentation or creating videos to share knowledge and help the users explain how a particular service or feature works.
          <br/><br/>
          2. <strong>Help train and onboard new support teammates:</strong> Helping new hires and training them for long-term success is a critical task and a fulfilling one. It helps in sharing knowledge, fostering growth, and building a strong team. I have mentored a couple of new hires so far and it helps both the mentee and the mentor to grow personally as well as professionally.
          <br/><br/>
          3. <strong>Work with the product team to develop a new feature based on feedback from customers:</strong> This is a rewarding task. Working directly with the product team to build new features based on user feedback allows you to have an influence on product development and ensure that customer needs are met.
          <br/><br/>
          4. <strong>Scheduling time-off coverage and collaborating as part of a growing cohesive support team:</strong> It is about being a team player and being available when the team needs it which helps in fostering team bonding and trust between the team members that is crucial for the success of the team.
          <br/><br/>
          5. <strong>Work with people to figure out if Vercel is suitable for their use case:</strong> Helping our customers to understand if Vercel is suitable for their use case is engaging and impactful. It helps to gain more knowledge about the product through different use-cases, and get a chance to build a trust relationship with the customer which helps in the long-term.
          <br/><br/>
          <strong>5 least favourite support tasks:</strong>
          <br/><br/>
          1. <strong>Respond to 25+ support cases via email every day:</strong> While I enjoy working hard and handling a high volume of cases, as a senior support engineer, I believe my focus should shift towards high-priority tasks like managing urgent or escalated tickets, mentoring, and collaborating with the product team. This would better utilize my skills and benefit the team more effectively. High-volume repetitive tasks may not significantly enhance my skills or knowledge.
          <br/><br/>
          2. <strong>Help resolve billing issues for customers:</strong> I believe billing issues can be complex and time-consuming to troubleshoot unless there is a bug in the product billing system. Generally, such issues should be directly handled by the respective team who manages the billing in order to have an effective communication with the customer and avoid any communication gap or delays.
          <br/><br/>
          3. <strong>Run ticket review sessions to make sure tone is consistent:</strong> I understand ensuring a consistent tone is an important part while working with the customer and it should be the support engineer’s responsibility to ensure that the tone is correct. If a team member has requested for a ticket review session, then I would be happy to help.
          <br/><br/>
          4. <strong>Engage multiple users at once in a public discussion, to answer their questions and troubleshoot problems:</strong> Managing multiple users at once in a public discussion can be stressful and overwhelming at times.
          <br/><br/>
          5. <strong>Find and recruit teammates for the support team:</strong> Finding and recruiting teammates for the support team can be a time-consuming and demanding process. However, if required, I'd be happy to do it.
          <br/><br/>
          <strong>What do you want to learn or do more of at work?</strong> I want to grow myself both personally and professionally by working on more challenging issues, providing mentorship to new hires, and get critical feedback from the leadership to constantly upskilling myself.
          <br/><br/>
          <strong>Describe how you solved a challenge or technical issue that you faced in a previous role (preferably in a previous support role). How did you determine that your solution was successful?</strong>
          <br/><br/>
          ...
          <br/><br/>
          <strong>Root Cause:</strong> Issue occurred because ec2 instances did not have the public IPs associated with them due to which the network connection between data plane and dremio cloud control plane was getting timed out.
          <br/><br/>
          ...
          <br/><br/>
          <strong>When would you choose to use Edge Functions, Serverless Functions, or Edge Middleware with Vercel?</strong>
          <br/>
          ...
          <br/><br/>
          <strong>Imagine a customer writes in requesting help with a build issue on a framework or technology that you've not seen before. How would you begin troubleshooting this and what questions would you ask the customer to understand the situation better?</strong>
          <br/>
          ...
          <br/><br/>
          <strong>The customer from question 5 replies to your response with the below:</strong>
          <br/>
          ...
          Payal
          <br/><br/>
          <strong>A customer writes in to the Helpdesk asking "How do I do a redirect from the /blog path to https://example.com?" Please write a reply to the customer. Feel free to add any information about your decision making process after the reply.</strong>
          <br/><br/>
          Hi [Customer Name], 
          <br/><br/>
          ...
          Payal
          <br/><br/>
          <strong>A customer is creating a site and would like their project not to be indexed by search engines. Please write a reply to the customer. Feel free to add any information about your decision making process after the reply.</strong>
          <br/><br/>
          Hi [customer-name],
          <br/><br/>
          ...
          Payal
          <br/><br/>
          <strong>What do you think is one of the most common problems which customers ask Vercel for help with? How would you help customers to overcome common problems, short-term and long-term?</strong>
          <br/><br/>
          ...
          <br/><br/>
          <strong>How could we improve or alter this familiarisation exercise?</strong>
          <br/>
